...
class class_identifier <<extends superclass_identifier>> {
    <<main_method>>
    <<private {
        {{ private_method1_decl | private_var1_decl | init1_decl }}
        <<{{ private_method2_decl | private_var2_decl | init_decl }}>>
        <<...>>
    }>>
    <<protected {
        {{ protected_method1_decl | protected_var1_decl | init1_decl }}
        <<protected_method2_decl | protected_var2_decl | init2_decl>>
        <<...>>
    }>>
    <<public {
...
An anonymous class definition takes a class instatiation and places it in the position of the class keyword from class declaration.
