 ...
 */
char *m_classes[] = {
	"t_Boolean", "t_Float", "t_IOTest", "t_Integer", "t_Object", "t_Printer", "t_Scanner",
	"t_String", "t_System"
};
 ...
 */
enum m_class_idx {
	T_BOOLEAN = 0, T_FLOAT, T_IOTEST, T_INTEGER, T_OBJECT, T_PRINTER, T_SCANNER,
	T_STRING, T_SYSTEM
};
...
void init_class_infos() {
	init_built_in_infos();
	class_info_init(&M_IOTest, 2, m_classes[T_OBJECT], m_classes[T_IOTEST]);
}
 ...
 */
struct t_IOTest *f_00000001_init(struct t_IOTest *);
void f_00000002_interact(struct t_IOTest *);
void f_00000003_prompt(struct t_IOTest *, struct t_String *);
struct t_Integer *f_00000004_promptInteger(struct t_IOTest *, struct t_String *);
struct t_Float *f_00000005_promptFloat(struct t_IOTest *, struct t_String *);
void f_00000006_main(struct t_System *, struct t_String **);
...
struct t_IOTest *f_00000001_init(struct t_IOTest *this)
{
...
void f_00000002_interact(struct t_IOTest *this)
{
	struct t_Printer *v_p = ((struct t_Printer *)(((this->Object).v_system)->System.v_out));
	struct t_Integer *v_i = ((struct t_Integer *)(f_00000004_promptInteger(((struct t_IOTest *)(this)), LIT_STRING("Please enter an integer"))));
	struct t_Float *v_f = ((struct t_Float *)(f_00000005_promptFloat(((struct t_IOTest *)(this)), LIT_STRING("Please enter a float"))));
	( printer_print_string(((struct t_Printer *)(v_p)), LIT_STRING("Sum of integer + float = ")) );
	( printer_print_float(((struct t_Printer *)(v_p)), ADD_FLOAT_FLOAT( integer_to_f(((struct t_Integer *)(v_i))) , v_f )) );
	( printer_print_string(((struct t_Printer *)(v_p)), LIT_STRING("\n")) );
}


void f_00000003_prompt(struct t_IOTest *this, struct t_String *v_msg)
{
	( printer_print_string(((struct t_Printer *)(((this->Object).v_system)->System.v_out)), v_msg) );
	( printer_print_string(((struct t_Printer *)(((this->Object).v_system)->System.v_out)), LIT_STRING(": ")) );
}


struct t_Integer *f_00000004_promptInteger(struct t_IOTest *this, struct t_String *v_msg)
{
	( f_00000003_prompt(((struct t_IOTest *)(this)), v_msg) );
	return ( scanner_scan_integer(((struct t_Scanner *)(((this->Object).v_system)->System.v_in))) );
}


struct t_Float *f_00000005_promptFloat(struct t_IOTest *this, struct t_String *v_msg)
{
	( f_00000003_prompt(((struct t_IOTest *)(this)), v_msg) );
	return ( scanner_scan_float(((struct t_Scanner *)(((this->Object).v_system)->System.v_in))) );
}


void f_00000006_main(struct t_System *v_system, struct t_String **v_args)
{
	struct t_IOTest *v_test = ((struct t_IOTest *)(f_00000001_init(MAKE_NEW(IOTest))));
	( f_00000002_interact(((struct t_IOTest *)(v_test))) );
}
...
int main(int argc, char **argv) {
	INIT_MAIN(CASES)
	if (!strncmp(gmain, "IOTest", 7)) { f_00000006_main(&global_system, str_args); return 0; }
	FAIL_MAIN(CASES)
	return 1;
}
